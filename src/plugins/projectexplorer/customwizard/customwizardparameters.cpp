                                               ...
                                               QString *errorMessage)
{
    ...
    return true;
#else
    qWarning() << "CustomWizardValidationRule::validateRules not implemented";
    return false;
#endif
}
...
bool CustomWizardValidationRule::validate(QJSEngine &engine, const QMap<QString, QString> &replacementMap) const
{
    ...
    bool valid = false;
    QString errorMessage;
    // RK: if (!Utils::TemplateEngine::evaluateBooleanJavaScriptExpression(engine, cond, &valid, &errorMessage))
    {
